...
def test_SessionsPerPoint1():
	runner = CliRunner()
	result = runner.invoke(ev_group46.SessionsPerPoint, ['--point', '5f69795300355e4c010658b6_119350', '--datefrom', '20190901', '--dateto', '20190902', '--apikey', 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImlhdCI6MTYxNTMyMDQ0N30.mwPWMrQ5vlt14aoyoelvtRBUIZPZJbOGDVggV81FC4YxQWlms_6dziLYsf2Q1oPWIIargNIKl2r3k7yZCNbhbA'])
	#print(result.output)
	assert result.exit_code == 0
...
def test_SessionsPerEV():
	...
	tok = json.load(token_file)
	apikey = tok['token']
	result = runner.invoke(ev_group46.SessionsPerEV, ['--ev', '926efa33-4c55-43df-80f3-4b8d2d65a00a', '--datefrom', '20190901', '--dateto', '20190902', '--format', 'csv', '--apikey', apikey])
	print(result.output)
	assert result.exit_code == 0
